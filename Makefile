...
CXX_OBJS += $(CHANEVENTO) $(CHANIDENTIFIERO) $(CORRELATORO) $(DETECTORDRIVERO) \
	...
	$(MAPFILEO) $(PATHHOLDERO) $(PIXIEO) $(PLACESO) $(PLACEBUILDERO) \
	$(PUGIXMLO) $(RANDOMPOOLO) $(RAWEVENTO) $(READBUFFDATAO) $(STATSDATAO) \
...
ifdef PULSEFIT
CXX_OBJS += $(FITTINGANALYZERO) $(VANDLETIMINGO) $(SIPMTFASTTIMINGO)
else ifdef DCFD
