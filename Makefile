...
IS600PROCESSORO   = IS600Processor.$(ObjSuf)
IS600GEPROCESSORO = IS600GeProcessor.$(ObjSuf)
IS600LOGICPROCESSORO = IS600LogicProcessor.$(ObjSuf)
IS600DOUBLEBETAPROCESSORO = IS600DoubleBetaProcessor.$(ObjSuf)
...
CXX_OBJS += $(IS600PROCESSORO)  $(IS600LOGICPROCESSORO) $(IS600GEPROCESSORO)\
	$(IS600DOUBLEBETAPROCESSORO)
